...
const Signup = () => {
    ...
    const handleSignUp = async (e) => {
        ...
        setLoading(true);
        try {
            const result = await axios.post(`${base_url}/api/auth/signUp`, { name, email, password }, {
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-10 pr-4 py-3 border ${validationName ? 'border-red-500' : 'border-gray-300'
                            ...
                            {validationName && (
                                <p className="text-red-500 text-xs mt-1 flex items-center">
                                    <span className="mr-1">⚠</span> {validationName}
                                </p>
                            )}
                        </div>
                        <div className="space-y-1">
